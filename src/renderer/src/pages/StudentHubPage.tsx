...
type StudentSection = 'dashboard' | 'progress' | 'chat'

const SECTIONS: StudentSection[] = ['dashboard', 'progress', 'chat']
      ...
      <div className="flex flex-1 min-h-0">
        ...
        <main className="flex-1 flex flex-col min-h-0 overflow-auto">
          <div className="p-6 border-b border-[var(--color-border)]">
            <h1 className="text-xl font-bold">{activeItem?.label ?? t('roles.studentHub')}</h1>
          </div>
          <PlaceholderPanel
